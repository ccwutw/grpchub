...
func (c *greeterClient) LotsOfReplies(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (Greeter_LotsOfRepliesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[0], "/message.Greeter/LotsOfReplies", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) ManyHellos(ctx context.Context, opts ...grpc.CallOption) (Greeter_ManyHellosClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[1], "/message.Greeter/ManyHellos", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *greeterManyHellosClient) Recv() (*HelloReply, error) {
	m := new(HelloReply)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (UnimplementedGreeterServer) ManyHellos(Greeter_ManyHellosServer) error {
	return status.Errorf(codes.Unimplemented, "method ManyHellos not implemented")
}
...
func (x *greeterManyHellosServer) Send(m *HelloReply) error {
	return x.ServerStream.SendMsg(m)
}
